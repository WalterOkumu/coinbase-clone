      ...
      >
        {
          coins.map((coin, index) => (
            <View key = {index}>
              ...
              >
                <View>
                  <Image source = {{uri:coin.icon}} style = {{ width: 35, height: 35, marginTop: 15 }}/>
                </View>
                ...
                <View style = {{ marginTop: 15, flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style = {{ fontSize: 12, fontWeight: '400', paddingLeft: 5, color: '#5d616d' }}>
                    ${coin.price}
                  </Text>
                </View>
                <View style = {{ paddingTop: 15 }}>
                  <Text style = {{ fontSize: 30, fontWeight: '400', paddingLeft: 5, color: 'red' }}>
                    {coin.drop}%
                  </Text>
                </View>
              </View>
